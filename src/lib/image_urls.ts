export const nbaHeadshotUrl = (nbaId: string) =>
  `https://cdn.nba.com/headshots/nba/latest/1040x760/${nbaId}.png`;

/** Maps full team name (as stored in the DB) to the NBA team ID. */
...
export function nbaTeamLogoUrl(teamName: string): string | null {
