  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white">
      <header className="flex items-center justify-between px-8 py-5 border-b border-white/10">
        ...
        <h1 className="text-lg font-bold text-gray-300">Leaderboard</h1>
      </header>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <ol className="flex flex-col gap-2">
          {ranked.map((player) => (
            <li
              key={player.id}
              className="flex items-center gap-4 bg-gray-900 rounded-xl px-4 py-3 border border-white/5"
            >
              {/* Rank */}
              ...
              {/* Photo */}
              <div className="relative w-12 h-9 shrink-0 rounded-lg overflow-hidden bg-gray-800">
                <Image
